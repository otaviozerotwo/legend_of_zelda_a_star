function distanciaEuclidiana(inicio, fim) {
  ...
  // console.log('1 - Inicio: ', inicio);
  // console.log('2 - Fim: ', fim);

  return console.log('3 - Distancia Euclidiana: ', Math.sqrt(Math.pow(x2 - x1, 2) + Math.pow(y2 - y1, 2)));
}
...
function aStar(matrizMapaHyrule, inicio, fim) {
  ...
  // console.log('4 - Posição: ', inicio);
  console.log('5 - Lista Aberta: ', listaAberta);
  // console.log('6 - Lista Fechada: ', listaFechada);
  console.log('7 - Tamanho Lista Aberta: ', listaAberta.length);

  while (listaAberta.length > 0) {
    // console.log('8 - Entrei no while!');

    const posicaoAtual = encontrarMenorValorF(listaAberta);

    // console.log('9 - Lista Aberta: ', listaAberta);
    console.log('10 - Posição Atual: ', posicaoAtual);

    if (posicaoAtual.posicao[0] === fim[0] && posicaoAtual.posicao[1] === fim[1]) {
      
      // console.log('11 - Caminho encontrado!');
      // console.log('12 - Lista Aberta: ', listaAberta);
